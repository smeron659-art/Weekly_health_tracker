  ...
  return (
    <View style={styles.continer}>
      ...
      <View style={styles.text}>
        ...
        <Text style={{ marginHorizontala: 50 }}> </Text>{" "}
        <Text style={styles.titlel}> Time Takens</Text>
      </View>
      ...
      >
        {teker.map((item, index) => (
          <View key={index} style={{ flexDirection: "row" }}>
            <Text style={{ marginHorizontal: 50, color: "#fff", fontSize: 20 }}>
              {item}
            </Text>
      ...
      <TouchableOpacity onPress={back} style={styles.touchable}>
        {" "}
